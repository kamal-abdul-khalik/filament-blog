    ...
    <div class="flex justify-between items-center border-b border-gray-100">
        <div class="text-gray-500">
            @if ($this->activeCategory || $search)
                <button class="text-red-600 bg-gray-200 rounded-md p-1 hover:text-gray-900 text-xs mr-3"
            ...
            @if ($this->activeCategory)
                <span class="text-sm">From Category:</span>
            ...
            @endif
            @if ($search)
                <span class="text-sm">Containing:</span> <span class=" font-bold">{{ $search }}</span>
            @endif
        </div>
